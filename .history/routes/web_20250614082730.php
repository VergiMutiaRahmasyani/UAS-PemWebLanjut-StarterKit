...
// Halaman utama (login/register jika belum login, dashboard jika sudah)
Route::get('/', function () {
    if (Auth::check()) {
...
// Redirect /home ke dashboard (override dari Auth::routes())
...
// Berita routes (publik dan authenticated)
Route::get('/berita-publik', [BeritaController::class, 'indexPublik'])->name('berita.publik');
Route::middleware('auth')->group(function () {
