    ...
    public function store(Request $request)
    {
        try {
            ...
            if ($request->hasFile('image')) {
                ...
                $berita->image = $file->store('berita', 'public');
                \Log::info('Gambar disimpan: ' . $berita->image);
            } else {
                \Log::warning('Tidak ada file gambar yang diunggah.');
            }
            ...
            return redirect()->back()->with('error', 'Gagal menyimpan berita. Silakan coba lagi atau hubungi administrator. Detail: ' . $e->getMessage());
        }   
    }
